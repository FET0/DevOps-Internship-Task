...
exports.mockAzureAksServiceTests = exports.mockAzureARMResourcesTests = exports.mockKuduServiceTests = exports.mockAzureAppServiceTests = exports.mockAzureApplicationInsightsTests = exports.mockAzureARMAppInsightsWebTests = exports.getMockEndpoint = exports.nock = void 0;
...
function getMockEndpoint(scheme, msiClientId) {
    ...
    var endpoint = {
        ...
        applicationTokenCredentials: new azure_arm_common_1.ApplicationTokenCredentials("MOCK_SERVICE_CONNECTION", "MOCK_SPN_ID", "MOCK_TENANT_ID", "MOCK_SPN_KEY", "https://management.azure.com/", "https://login.windows.net/", "https://management.azure.com/", false, scheme, msiClientId)
    };
    (0, exports.nock)("https://login.windows.net", {
        reqheaders: {
...
function mockAzureARMAppInsightsWebTests() {
    var MockWebTest1 = {
        type: '',
        location: '',
        tags: {},
    ...
    (0, exports.nock)('https://management.azure.com', {
        reqheaders: {
...
exports.mockAzureARMAppInsightsWebTests = mockAzureARMAppInsightsWebTests;
function mockAzureApplicationInsightsTests() {
    (0, exports.nock)('https://management.azure.com', {
        reqheaders: {
            "authorization": "Bearer DUMMY_ACCESS_TOKEN",
            "content-type": "application/json; charset=utf-8"
...
exports.mockAzureApplicationInsightsTests = mockAzureApplicationInsightsTests;
function mockAzureAppServiceTests() {
    (0, exports.nock)('https://management.azure.com', {
        reqheaders: {
            "authorization": "Bearer DUMMY_ACCESS_TOKEN",
            "content-type": "application/json; charset=utf-8"
    ...
    }).delete("/subscriptions/MOCK_SUBSCRIPTION_ID/resourceGroups/MOCK_RESOURCE_GROUP_NAME/providers/Microsoft.Web/sites/MOCK_APP_SERVICE_NAME/slots/MOCK_SLOT_NAME?api-version=2016-08-01")
        .reply(200, {}).persist();
    (0, exports.nock)('https://management.azure.com', {
        reqheaders: {
            "authorization": "Bearer DUMMY_ACCESS_TOKEN",
...
exports.mockAzureAppServiceTests = mockAzureAppServiceTests;
function mockKuduServiceTests() {
    (0, exports.nock)('http://MOCK_SCM_WEBSITE').
        put('/api/deployments/MOCK_DEPLOYMENT_ID').reply(200, {
        type: 'Deployment',
        url: 'http://MOCK_SCM_WEBSITE/api/deployments/MOCK_DEPLOYMENT_ID'
    });
    (0, exports.nock)('http://FAIL_MOCK_SCM_WEBSITE').
    ...
    (0, exports.nock)('http://MOCK_SCM_WEBSITE').delete('/api/vfs/site/wwwroot/hello.txt').reply(200);
    (0, exports.nock)('http://FAIL_MOCK_SCM_WEBSITE').delete('/api/vfs/site/wwwroot/web.config').reply(501, 'Internal error occured');
    (0, exports.nock)('http://MOCK_SCM_WEBSITE').
    ...
    (0, exports.nock)('http://MOCK_SCM_WEBSITE.scm.azurewebsites.net').
    ...
    (0, exports.nock)('http://FAIL_MOCK_SCM_WEBSITE.scm.azurewebsites.net').
...
exports.mockKuduServiceTests = mockKuduServiceTests;
function mockAzureARMResourcesTests() {
    (0, exports.nock)('https://management.azure.com', {
        reqheaders: {
            "authorization": "Bearer DUMMY_ACCESS_TOKEN",
            "content-type": "application/json; charset=utf-8"
...
exports.mockAzureARMResourcesTests = mockAzureARMResourcesTests;
function mockAzureAksServiceTests() {
    (0, exports.nock)('https://management.azure.com', {
        reqheaders: {
            "authorization": "Bearer DUMMY_ACCESS_TOKEN",
            "content-type": "application/json; charset=utf-8"
...
exports.mockAzureAksServiceTests = mockAzureAksServiceTests;
