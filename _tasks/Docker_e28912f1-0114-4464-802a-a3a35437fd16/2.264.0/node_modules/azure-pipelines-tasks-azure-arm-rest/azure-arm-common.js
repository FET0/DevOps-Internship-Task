        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (this.scheme) {
                case AzureModels.Scheme.ManagedServiceIdentity:
                    ...
                    return new identity_1.ManagedIdentityCredential(this.msiClientId);
                case AzureModels.Scheme.WorkloadIdentityFederation:
                    ...
                    return new identity_1.WorkloadIdentityCredential({
                ...
                default:
                    ...
                    if (this.authType === constants.AzureServicePrinicipalAuthentications.servicePrincipalKey) {
                        ...
                        return new identity_1.ClientSecretCredential(this.tenantId, this.clientId, this.secret);
                    }
                    else {
                        tl.debug('Using ClientCertificateCredential for certificate-based SPN');
                        return new identity_1.ClientCertificateCredential(this.tenantId, this.clientId, this.certFilePath);
                    }
            }
        });
    }
