...
function sendRequest(request, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        requestOptions.globalAgentOptions = options === null || options === void 0 ? void 0 : options.httpGlobalAgentOptions;
        requestOptions.socketTimeout = options === null || options === void 0 ? void 0 : options.socketTimeout;
        const httpCallbackClient = new httpClient.HttpClient(tl.getVariable("AZURE_HTTP_USER_AGENT"), null, requestOptions);
        while (true) {
            try {
                let response = yield sendRequestInternal(request, httpCallbackClient);
...
function sendRequestInternal(request, httpCallbackClient) {
    return __awaiter(this, void 0, void 0, function* () {
