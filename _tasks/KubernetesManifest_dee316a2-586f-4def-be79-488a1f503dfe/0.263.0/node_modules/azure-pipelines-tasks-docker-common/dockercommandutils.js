...
exports.getImageFingerPrint = exports.getImageRootfsLayers = exports.getHistory = exports.extractSizeInBytes = exports.getImageSize = exports.getImageFingerPrintV1Name = exports.getLayers = exports.getPipelineUrl = exports.useDefaultBuildContext = exports.getBuildContext = exports.getBuildAndPushArguments = exports.getPipelineLogsUrl = exports.getCreatorEmail = exports.getCommandArguments = exports.stop = exports.start = exports.push = exports.command = exports.build = void 0;
...
function build(connection, dockerFile, commandArguments, labelArguments, tagArguments, onCommandOut) {
...
exports.push = push;
function start(connection, container, commandArguments, onCommandOut) {
    var command = connection.createCommand();
    command.arg("start");
...
exports.start = start;
function stop(connection, container, commandArguments, onCommandOut) {
    var command = connection.createCommand();
    command.arg("stop");
    command.arg(container);
    command.line(commandArguments);
...
exports.getCreatorEmail = getCreatorEmail;
function getPipelineLogsUrl() {
    let pipelineUrl = "";
    if (isBuild) {
...
exports.getPipelineLogsUrl = getPipelineLogsUrl;
function getBuildAndPushArguments(dockerFile, labelArguments, tagArguments) {
...
exports.getBuildAndPushArguments = getBuildAndPushArguments;
function getBuildContext(dockerFile) {
...
exports.getBuildContext = getBuildContext;
function useDefaultBuildContext(buildContext) {
...
exports.useDefaultBuildContext = useDefaultBuildContext;
...
function getImageFingerPrintV1Name(history) {
    let v1Name = "";
    if (!history) {
        return null;
    }
...
exports.getImageFingerPrintV1Name = getImageFingerPrintV1Name;
...
function parseHistoryForLayers(input) {
    const NOP = '#(nop)';
...
function getImageRootfsLayers(connection, imageDigest) {
    return __awaiter(this, void 0, void 0, function* () {
        var command = connection.createCommand();
        command.arg("inspect");
...
exports.getImageRootfsLayers = getImageRootfsLayers;
function getImageFingerPrint(rootLayers, v1Name) {
    let v2_blobs = [];
    let v2Name = "";
...
exports.getImageFingerPrint = getImageFingerPrint;
function getDigest(imageId) {
...
function generateV2Name(input) {
    return crypto.createHash("sha256").update(input).digest("hex");
}
function isBuildKitBuild() {
