 ...
 */
function getPackagingUris(protocolType, webApiOptions) {
    return __awaiter(this, void 0, void 0, function* () {
...
;
function getFeedRegistryUrl(packagingUrl, registryType, feedId, project, accessToken, useSession, webApiOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        let loc;
        switch (registryType) {
