...
function getClientToolFromService(serviceUri, accessToken, toolName, webApiOptions) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getWebApiWithProxy(serviceUri, accessToken, webApiOptions) {
    if (!accessToken) {
...
function getBlobstoreUriFromBaseServiceUri(serviceUri, accesstoken, webApiOptions) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getServiceUriFromAreaId(serviceUri, accessToken, areaId, webApiOptions) {
    return __awaiter(this, void 0, void 0, function* () {
