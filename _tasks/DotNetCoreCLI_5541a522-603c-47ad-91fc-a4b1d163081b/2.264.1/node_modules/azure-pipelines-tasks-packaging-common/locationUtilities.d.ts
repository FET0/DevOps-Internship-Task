...
export declare function getServiceUriFromAreaId(serviceUri: string, accessToken: string, areaId: string, webApiOptions?: RequestOptions): Promise<string>;
 ...
 */
export declare function getPackagingUris(protocolType: ProtocolType, webApiOptions?: RequestOptions): Promise<PackagingLocation>;
/** Return a masked SystemAccessToken */
export declare function getSystemAccessToken(): string;
export declare function getWebApiWithProxy(serviceUri: string, accessToken?: string, webApiOptions?: RequestOptions): vsts.WebApi;
...
export declare function getFeedRegistryUrl(packagingUrl: string, registryType: RegistryType, feedId: string, project: string, accessToken?: string, useSession?: boolean, webApiOptions?: RequestOptions): Promise<string>;
