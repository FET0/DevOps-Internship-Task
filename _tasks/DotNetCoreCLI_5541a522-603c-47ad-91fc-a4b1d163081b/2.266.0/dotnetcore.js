...
class dotNetExe {
    ...
    getIsMicrosoftTestingPlatform() {
        ...
        try {
            const testRunner = (_b = (_a = JSON5.parse(globalJsonContents)) === null || _a === void 0 ? void 0 : _a.test) === null || _b === void 0 ? void 0 : _b.runner;
    ...
    executeTestCommand() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isMTP = !tl.getPipelineFeature('DisableDotnetConfigDetection') && this.getIsMicrosoftTestingPlatform();
