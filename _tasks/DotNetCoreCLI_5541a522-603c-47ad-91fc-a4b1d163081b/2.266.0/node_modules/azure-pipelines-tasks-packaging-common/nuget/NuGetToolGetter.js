...
exports.resolveNuGetVersion = exports.cacheBundledNuGet = exports.getMSBuildVersion = exports.getMSBuildVersionString = exports.getNuGet = exports.NUGET_EXE_TOOL_PATH_ENV_VAR = exports.DEFAULT_NUGET_PATH_SUFFIX = exports.DEFAULT_NUGET_VERSION = exports.NUGET_VERSION_4_0_0_PATH_SUFFIX = exports.NUGET_VERSION_4_0_0 = exports.FORCE_NUGET_4_0_0 = void 0;
...
const ProductVersionHelper_1 = require("./ProductVersionHelper");
...
const NUGET_SCRIPT_FILENAME = 'nuget';
...
exports.DEFAULT_NUGET_VERSION = '4.9.6';
exports.DEFAULT_NUGET_PATH_SUFFIX = 'NuGet/4.9.6/';
exports.NUGET_EXE_TOOL_PATH_ENV_VAR = 'NuGetExeToolPath';
function getNuGet(versionSpec, checkLatest, addNuGetToPath, requestOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (toolPath) {
            ...
            let versionInfo = yield getLatestMatchVersionInfo(versionSpec, requestOptions);
...
function generateNugetScript(nugetToolPath, nugetExePath) {
    ...
    if (fs.existsSync(nugetScriptPath)) {
        ...
        fs.writeFile(nugetScriptPath, `#!/bin/sh\nmono ${nugetExePath} "$@"\n`, (err) => {
            if (err) {
...
function getMSBuildVersionString() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (path) {
            ...
            try {
                const msbuildVersion = yield peParser.getFileVersionInfoAsync(path);
                version = ProductVersionHelper_1.getVersionFallback(msbuildVersion).toString();
...
function cacheBundledNuGet(cachedVersionToUse, nugetPathSuffix) {
    return __awaiter(this, void 0, void 0, function* () {
        if (cachedVersionToUse == null) {
            cachedVersionToUse = yield resolveNuGetVersion();
...
function resolveNuGetVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        let nugetVersionToUse;
        ...
        if (msbuildSemVer && semver.gte(msbuildSemVer, '17.0.0')) {
            ...
            nugetVersionToUse = exports.DEFAULT_NUGET_VERSION;
        }
        return nugetVersionToUse;
    });
}
exports.resolveNuGetVersion = resolveNuGetVersion;
...
function getLatestMatchVersionInfo(versionSpec, requestOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let releasedVersions = nugetVersions.filter(x => x.stage.toString() === NuGetReleaseStage[NuGetReleaseStage.ReleasedAndBlessed]);
