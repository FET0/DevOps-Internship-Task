...
class NpmRegistry {
    ...
    static FromServiceEndpoint(endpointId, authOnly, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (endpointAuth.scheme === 'Token') {
                    isVstsTokenAuth = yield NpmRegistry.isEndpointInternal(url, requestOptions);
                }
    ...
    static isEndpointInternal(endpointUri, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            let options;
            try {
            ...
            const endpointClient = new HttpClient_1.HttpClient(tl.getVariable('AZURE_HTTP_USER_AGENT'), null, options);
            try {
